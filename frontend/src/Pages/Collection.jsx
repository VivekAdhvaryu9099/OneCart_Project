...
const Collection = () => {
  ...
  return (
    ...
    >
      <div
        className={`md:w-[30vw] lg:w-[20vw] w-[100vw] md:min-h-[100vh]  p-[20px] border-r-[1px] border-gray-400  text-[#aaf5fa] lg:fixed `}
      >
        ...
        <div
          className={`border-[2px] border-[#dedcdc] pl-5 py-3 ${showFilter ? "" : "hidden"} mt-6 rounded-md bg-slate-600  md:block`}
        >
         ...
         <div className={`border-[2px] border-[#dedcdc] ${showFilter ? "" : "hidden"} pl-5 py-3 mt-6 rounded-md bg-slate-600 md:block`}>
            ...
            <div className=' md:w-[80vw] w-[100vw]    flex  justify-between flex-col lg:flex-row lg:px-[50px] '>
                <Title  text1={"ALL"} text2={"COLLECTIONS"}/>
                  ...
                  <select name="" id="" className='bg-slate-600 w-[60%] md:w-[200px] h-[50px]
                   px-[10px] text-[white] rounded-lg hover:border-[#46d1f7] border-[2px]' onChange={(e)=>SetSortType(e.target.value)}>
