...
const CartTotal = () => {
    const {currency , delhivery_fee , getCartAmount} = useContext(shopDataContext)
  return (
    <div className='w-full lg:ml-[30px]'>
       ...
       <div className='flex justify-between text-white text-[18px] p-[10px]'>
        ...
        <hr/>
         <div className='flex justify-between text-white text-[18px] p-[10px]'>
          <p>Shipping Fee</p>
          <p>{currency} {delhivery_fee}</p>
        </div>
        <hr/>
        <div className='flex justify-between text-white text-[18px] p-[10px]'>
          <b>Total</b>
          <b>{currency} {getCartAmount()=== 0 ? 0 :getCartAmount() + delhivery_fee}</b>
        </div>
