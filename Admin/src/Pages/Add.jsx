...
const Add = () => {
  ...
  try {
    ...
    const result = await axios.post(`${serverUrl}/api/product/addPro`, formData, {
    ...
    >
      ...
      <div className="w-[82%] h-[100%] flex items-center justify-start overflow-x-hidden absolute right-0 ">
        ...
        >
          ...
          <div
            className="w-[80%] h-[130px] flex items-start justify-center
          ...
          <div className="w-[80%]  flex items-start justify-center flex-col gap-[10px] ">
            ...
            <input
              ...
              className="w-[600px] max-w-[98%] h-[40px] rounded-lg hover:border-[#46d1f7]
                         border-[2px] cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2]"
            ...
            <textarea
              ...
              className="w-[600px] max-w-[98%] h-[100px] rounded-lg hover:border-[#46d1f7]
                         border-[2px] cursor-pointer bg-slate-600 py-[20px] text-[18px] placeholder:text-[#ffffffc2]"
          ...
          <div className="w-[80%] flex items-center gap-[10px] flex-wrap">
            <div
              className="md:w-[30%] w-[100%] flex items-start sm:justify-center
                                flex-col gap-[10px]"
            >
            ...
            >
              ...
              <select
                id=""
                className="bg-slate-600 w-[100%] px-[10px] py-[7px] rounded-lg hover:border-[#46d1f7] border-[2px] "
          ...
          <button className="w-[140px] px-[20px] py-[20px] rounded-xl
           bg-[#65d8f7] flex items-center justify-center gap-[10px] text-black active:bg-slate-700
