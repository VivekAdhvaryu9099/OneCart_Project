...
const Login = () => {
  ...
  const AdminLogin = async (e) => {
    e.preventDefault();
    try {
        const result = await axios.post(serverUrl+'/api/auth/adminLogin',{email,pass},{withCredentials:true})
  ...
  return (
    <div className="w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white flex flex-col items-center justify-start">
      ...
      <div className="w-full h-[100px] flex flex-col items-center justify-center gap-[10px]">
        ...
        <span className="text-[16px]">Welcome Admin, Please Login</span>
      </div>
      ...
      <div className="max-w-[600px] w-[90%] h-[500px] bg-[#00000025] border border-[#96969635] backdrop-blur-2xl rounded-lg shadow-lg flex items-center justify-center">
        ...
        >
          ...
          <div className="w-[90%] flex flex-col items-center justify-center gap-[15px] relative">
            ...
            {show ? (
              <LuEye
                className="w-[25px] h-[25px] absolute right-[5%] bottom-[55%] cursor-pointer"
            ...
            <button className="w-full h-[50px] bg-[#6060f5] rounded-lg flex items-center justify-center mt-[20px] text-[17px] font-semibold cursor-pointer">
              Login
            </button>
          </div>
        </form>
